...
applyFiniteDiffMethodFor(partitionClass &partition,
        ...
        for (int l_ = parameter.LMIN; l_ <= parameter.LMAX; l_++) {
                ...
                partition.waveFunctionRe[l_][1] = 0.1;
                partition.waveFunctionIm[l_][0] = 0.0;
                partition.waveFunctionIm[l_][1] = 0.1;
                partition.waveFunctionPrimeRe[l_][0] = 0.1;
                partition.waveFunctionPrimeIm[l_][0] = 0.1;
...
main(void){
        ...
        int arraySize = 401;
        generalParametersClass generalParameters(arraySize, 0.0, 40.0, 0, 0, 1.E-6);
        partitionClass firstPartition("Zn67_d", true, 6.0, 2., 67., 1, 30,
                                      generalParameters);

        firstPartition.setWoodsSaxonParameters(-107.0, 4.26463, 0.86, -0.0000010 * 40.24, 6.22635, 0.884, 5.28001);
        firstPartition.l=0;
